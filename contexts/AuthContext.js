            ...
            signIn: async (email, password) => {
                ...
                try {
                    ...
                    if (error.code === 'auth/user-not-found') {
                        ...
                        setLoading(false);
                        setErrorMessages("E-mail ya da şifre hatalı. Lütfen bilgileri yeniden deneyerek tekrar deneyin");
                        // Alert.alert('Üzgünüz..🤔 bir hata ile karşılaştık',
                        //     "E-mail ya da şifre hatalı. Lütfen bilgileri yeniden deneyerek tekrar deneyin");
                    } else {
                        Alert.alert("Üzgünüz..🤔 bir hata ile karşılaştık", `${error.code}`);
                    }
                }
            },
            //Kayıt ol
                ...
                try {
                    ...
                    await firestore().collection('users').doc(auth().currentUser.uid)
                        .set({
                            ...
                            userProfileImagePath: "https://i4.hurimg.com/i/hurriyet/75/0x0/5d78ea1d45d2a023a0d4b139.jpg", //default profil resmi
                            userPetImgPath: null,
                            location: '',
                            job: '',
                            age: age,
                        ...
                        .then(res => {
                            firestore().collection('users').doc(res.user.uid)
                                .set({
                                    ...
                                    job: '',
                                    createdAt: firestore.FieldValue.serverTimestamp(),
                                    userProfileImagePath: "https://i4.hurimg.com/i/hurriyet/75/0x0/5d78ea1d45d2a023a0d4b139.jpg",
                                    userPetImgPath: '',
                                    age: null,
                                    gender: 'Belirtilmedi',
                                    availablePets: [],
