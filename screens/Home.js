...
const BG_IMAGE =
  'https://i.pinimg.com/564x/78/28/cb/7828cba384536458998a822f82ca0fc7.jpg';
//  Home  //
      ...
      <>
        <View style={styles.postContainer}>
          <View style={styles.postOwnerInfo}>
            ...
            <Overlay
              isVisible={MyBottomSheetVisible}
              containerStyle={{backgroundColor: 'transparent'}}
              onBackdropPress={toggleOverlayMyPost}>
            ...
            <Menu>
              ...
              <MenuOptions>
                ...
                <MenuOption
                  onSelect={() =>
                    ToastAndroid.show('Favorilerine Eklendi', 2000)
                  }>
                  <View style={{flexDirection: 'row'}}>
                    <Icon name='star' size={20} color='black' />
                    <Text style={{color: '#215', marginLeft: 10}}>
                      Favorilere Ekle
                    </Text>
                  </View>
                </MenuOption>
          ...
          <View
            ...
            <Image
              ...
              style={{width: width, height: 200, borderRadius: 10}}></Image>
          </View>
          ...
          <View style={styles.footerList}>
            ...
            <Text style={styles.date}>
              {item.dateStart.toDate().toLocaleDateString('tr-TR')}
            </Text>
            <Text style={styles.dateText}>Bitiş Tarihi:</Text>
            <Text style={styles.date}>
              {item.dateEnd.toDate().toLocaleDateString('tr-TR')}
            </Text>
            <Text>tarihleri için zamanlandı</Text>
          </View>
          <View>
            <Text style={styles.postTitle}>
              İlan Fiyatı : {item.postPrice} TL{' '}
            </Text>
          </View>
          ...
          <View style={styles.footer}>
            ...
            <Icon.Button
              ...
              color='black'
              backgroundColor='#fff'
              onPress={() => onShare(item && item.postTitle)}
            />
          </View>
