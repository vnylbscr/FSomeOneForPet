        ...
        <View style={{backgroundColor: 'transparent', borderRadius: 10}}>
          <TouchableOpacity onPress={() => navigation.navigate('AddPost')}>
            ...
            <Text
              ...
              Henüz ilan eklememişsin.
            </Text>
            <Text style={{fontFamily: 'Poppins-Regular', fontSize: 15}}>
              Buraya tıklayarak hemen ilan ekle!
            </Text>
          </TouchableOpacity>
        </View>
      </View>
          ...
          userPosts.map((post, id) => {
            return (
              <ListItem
                ...
                onPress={() =>
                  navigation.navigate('ShowPost', {itemid: post.postId})
                }>
                <ListItem.Content>
                  <Avatar
                    source={{uri: post.postImage}}
                    size='xlarge'
                    iconStyle={styles.postAvatar}
                  />
