...
const ShowPost = ({route, navigation}) => {
  ...
  const onShare = async () => {
    try {
      Share.open({
        message:
          'F SomeOne For Pet ile bakıcı bulmak artık çok kolay. Hemen sende katıl!',
        ...
        <View style={styles.container}>
          ...
          <View style={styles.infoContainer}>
            ...
            <Text style={styles.date}>
              {post.dateStart.toDate().toLocaleString('tr-TR')}
            </Text>
            <Text style={styles.subTitle}>Bitiş Tarihi</Text>
            <Text style={styles.date}>
              {post.dateEnd.toDate().toLocaleString('tr-TR')}
            </Text>
