          ...
          <View style={styles.userInfo}>
            <View style={{flexDirection: 'row', marginTop: 10}}>
              ...
              <View style={{marginLeft: 20}}>
                <Text
                  h3
                  h3Style={{fontSize: 20, fontFamily: 'Poppins-Regular'}}>
                  {userDataFromDb && userDataFromDb.username
                    ? userDataFromDb.username
                    : 'İsim belirtilmedi'}{' '}
                  ({userDataFromDb ? userDataFromDb.age : 'Yaş Belirtilmedi'})
                </Text>
                ...
                <View style={{flexDirection: 'row'}}>
                  <Text style={styles.textAbout}>
                    {userDataFromDb && userDataFromDb.about
                      ? userDataFromDb.about
                      : 'Hakkinda Belirtilmedi'}
                  </Text>
                </View>
                <View>
                  <Text style={styles.textAbout}>
          ...
          <View style={{flex: 1, flexDirection: 'row'}}>
            <View style={{flex: 2, marginLeft: 10, marginBottom: 10}}>
              <View style={styles.row}>
                ...
                <Text
                  ...
                  {' '}
                  {userDataFromDb && userDataFromDb.location
                    ? userDataFromDb.location
                    : 'Konum belirtilmedi'}
                </Text>
              </View>
              <View style={styles.row}>
                ...
                <Text
                  ...
                  h4Style={{fontWeight: '400', fontSize: 10, color: '#798777'}}>
                  {' '}
                  {userDataFromDb && userDataFromDb.gender
              ...
              <View style={styles.row}>
                ...
                <Text
                  ...
                  h4Style={{fontWeight: '400', fontSize: 10, color: '#798777'}}>
                  {' '}
                  {userDataFromDb && userDataFromDb.job
                    ? userDataFromDb.job
                    : 'Meslek belirtilmedi'}
                </Text>
              </View>
            ...
            <View style={{flex: 2}}>
              <View style={{backgroundColor: 'transparent'}}>
                <Text style={{fontSize: 12, color: '#798777'}}>
                  Bakabildiğin Petler
                </Text>
                {userDataFromDb && userDataFromDb.availablePets.length > 0 ? (
                  userDataFromDb.availablePets.map((item, id) => {
                    return (
                      <Text key={id} style={{color: '#798777'}}>
                        {item}
                      </Text>
                    );
                  })
                  ...
                  <TouchableOpacity
                    ...
                    <Text style={{fontSize: 12, color: '#798777'}}>
                      Bakabildiğin pet eklememişsin. Hemen ekle.
                    </Text>
                  </TouchableOpacity>
                )}
              </View>
