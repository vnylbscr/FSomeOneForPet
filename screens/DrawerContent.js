...
const BG_IMAGE = "https://i.pinimg.com/originals/c8/c5/36/c8c5362f878f23cea126740c99a33dbb.jpg";
            ...
            <View style={{ flex: 1 }}>
                <DrawerContentScrollView {...props} >
                    <View style={styles.userInfo}>
                        <Text style={styles.avatarText}>{userdata ? userdata.username + " (" + userdata.age + ")" : 'Yaş belirtilmedi'}</Text>
